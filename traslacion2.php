<?php
  ...
  <div class='container'>
          <div class='row'>
            <div class='col-sm-6' >
              <form action='traslacion3.php' method='post' >";
              $num=$_POST["vertices"];
              for($i=0;$i<$num;$i++)
              {
                echo 
                ...
                echo "<div class='form-group'>
                  <label for='h'>Horizontal (H):  </label>
                    <div class='input-group'>
                      <span class='input-group-addon' id='basic-addon1'><span class='glyphicon glyphicon-star'></span></span>
                      <input type='text' name='h' class='form-control'  aria-describedby='basic-addon1'>
                    </div>
                </div> 

                <div class='form-group'>
                  <label for='v'>Vertical (V):  </label>
                    <div class='input-group'>
                      <span class='input-group-addon' id='basic-addon1'><span class='glyphicon glyphicon-star'></span></span>
                      <input type='text' name='v' class='form-control'  aria-describedby='basic-addon1'>
                    </div>
                </div>";
