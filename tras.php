...
<head>
    ...
    <script type='text/javascript'>
        ...
        function dibujar(ctx){
                    /*ctx.moveTo(<?php echo $x[0]; ?>, <?php echo $py; ?>);
                    ctx.lineTo(400,400);
                    ctx.strokeStyle = "#f00";
                    ctx.stroke(); */
                   
         
            /*for (<?php echo $i; ?> = 0; i <=<?php echo $num0; ?>; (<?php echo $i; ?>++) {
                    //ctx.fillStyle="#000";
                //ctx.fillRect(400,250,<?php echo $x; ?>,<?php echo $y; ?>);
                if (<?php echo $i; ?>==(<?php echo $num0; ?> - 1))
                {
                    ctx.moveTo(<?php echo $x[$i]; ?>, <?php echo $y[$i];?>);
                    ctx.lineTo(<?php echo $x[0]; ?>, <?php echo $y[0];?>);
                    ctx.strokeStyle = "#f00";
                    ctx.stroke();
                }
                    ...
                    {
                        ctx.moveTo(<?php echo $x[$i]; ?>, <?php echo $y[$i]; ?>);
                    ctx.lineTo(<?php echo $x[$i+1]; ?>, <?php echo $y[$i + 1];?>);
                    ctx.strokeStyle = "#f00";
                    ctx.stroke();
                    }
            }*/
...
<section id="services">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 text-center">
                    <div class="service-box">
                        <input name="button" type="button" onclick="mover();" value="dibujar" class="btn btn-primary btn-block btn-md" role="button" />
