<?php
...

  {
      ...
      imageline($gd, $xmin+900, $ymin, $xmax+900, $ymin, $rojo);
      imageline($gd, $xmax+900, $ymin, $xmax+900, $ymax, $rojo);
      imageline($gd, $xmax+900, $ymax, $xmin+900, $ymax, $rojo);
      imageline($gd, $xmin+900, $ymax, $xmin+900, $ymin, $rojo);

      for($i=0;$i<=$num0;$i++)
      {
        if($i==($num0-1))
        {
          imageline($gd, $poligono[$i][0],$poligono[$i][1], $poligono[0][0], $poligono[0][1], $blanco);
        }else
        {
        imageline($gd, $poligono[$i][0],$poligono[$i][1], $poligono[$i+1][0], $poligono[$i+1][1], $blanco);
        }
    ...
    for($i=0;$i<$num3-1;$i++)
      ...
      for($i=0;$i<$num4;$i++)
      {
         if($i==$num4-1)
         {
          imageline($gd, $poligono5[$i][0] +900,$poligono5[$i][1], $poligono5[0][0] + 900, $poligono5[0][1], $blanco); 
         }else
         {
         imageline($gd, $poligono5[$i][0] + 900 ,$poligono5[$i][1], $poligono5[$i+1][0] + 900, $poligono5[$i+1][1], $blanco);
        }
