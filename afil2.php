<?php
        ...
        <div class='container'>
            <div class='row'>
                <div class='col-lg-8 col-lg-offset-2 text-center'>
                    <h2 class='section-heading'>AFILAMIENTO</h2>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class='container'>
            <div class='row'>
                <div class='col-lg-12 text-center'>
                    <h2 class='section-heading'>Afilamiento de Polígonos</h2>
                    <hr class='primary'>
                </div>
            </div>
        </div>";
  ...
  <div class='container'>
          <div class='row'>
            <div class='col-sm-6' >
              <form action='afil3.php' method='post' >";
              $num=$_POST["vertices"];
              for($i=0;$i<$num;$i++)
              {
                echo 
              ...
              /*echo "<div class='form-group'>
                ...
                echo "<div class='form-group'>
                  <label for='ax'>Factor en (Ax):  </label>
                    <div class='input-group'>
                      <span class='input-group-addon' id='basic-addon1'><span class='glyphicon glyphicon-star'></span></span>
                      <input type='text' name='ax' class='form-control'  aria-describedby='basic-addon1'>
                    </div>
                </div> 

                <div class='form-group'>
                  <label for='ay'>Factor en (Ay):  </label>
                    <div class='input-group'>
                      <span class='input-group-addon' id='basic-addon1'><span class='glyphicon glyphicon-star'></span></span>
                      <input type='text' name='ay' class='form-control'  aria-describedby='basic-addon1'>
                    </div>
                </div>";
