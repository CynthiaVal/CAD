<?php
    ...
    echo
      "<!DOCTYPE html>
        ...
        <head>
         ...
         <title>Recorte de Polígonos</title>
        ...
        <div class='container'>
            <div class='row'>
                <div class='col-lg-8 col-lg-offset-2 text-center'>
                    <h2 class='section-heading'>ROTACIÓN</h2>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class='container'>
            <div class='row'>
                <div class='col-lg-12 text-center'>
                    <h2 class='section-heading'>ROTACIÓN DE POLÍGONOS</h2>
                    <hr class='primary'>
                </div>
            </div>
        </div>";
  ...
  <div class='container'>
          <div class='row'>
            <div class='col-sm-6' >
              <form action='rotacion3.php' method='post' >";
              $num=$_POST["vertices"];
              for($i=0;$i<$num;$i++)
              {
                echo 
              ...
              echo "<div class='form-group'>
                  <label for='px'>Punto Pivote PX </label>
                    <div class='input-group'>
                      <span class='input-group-addon' id='basic-addon1'><span class='glyphicon glyphicon-star'></span></span>
                ...
                echo "<div class='form-group'>
                  <label for='py'>Punto Pivote PY </label>
                    <div class='input-group'>
                      <span class='input-group-addon' id='basic-addon1'><span class='glyphicon glyphicon-star'></span></span>
                ...
                echo "<div class='form-group'>
                  <label for='alfa'>Angulo a girar (alfa):  </label>
                    <div class='input-group'>
                      <span class='input-group-addon' id='basic-addon1'><span class='glyphicon glyphicon-star'></span></span>
                      <input type='text' name='alfa' class='form-control'  aria-describedby='basic-addon1'>
                    </div>
                </div> ";
